...
var wasmBinaryFile = 'utilities.wasm';
...
var real__binarySearch = asm["binarySearch"];
asm["binarySearch"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__binarySearch.apply(null, arguments);
};
...
var _binarySearch = Module["_binarySearch"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["binarySearch"].apply(null, arguments)
};
...
const delete1={}
//console.log(delete1,det)

Module.extra= function(s,d){
  delete1.a=s;
  delete1.b=d;
  //console.log(delete1);
}
...
Module.onRuntimeInitialized=function () { 
  ...
  for (let i=0; i<delete1.b; i++) {
  // console.log(delete1.a[i])
  }
...
//console.log(t2-t1,"js");
  ...
  let bufferr = Module._malloc(delete1.a.length * delete1.a.BYTES_PER_ELEMENT);
  Module.HEAPF32.set(delete1.a, bufferr >> 2)

  //let t3 = performance.now();
  console.time('myTime2')

  let r = Module.ccall('binarySearch','number',["number", "number","number", "number"],[bufferr, 0, delete1.b, 5]);
