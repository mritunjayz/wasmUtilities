...
var real__myFunction = asm["myFunction"];
asm["myFunction"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _myFunction = Module["_myFunction"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["myFunction"].apply(null, arguments)
};
...
//console.log(t2-t1,"js");
  ...
  Module.ccall('myFunction','number',["number", "number"],[bufferr, delete1.b]);
